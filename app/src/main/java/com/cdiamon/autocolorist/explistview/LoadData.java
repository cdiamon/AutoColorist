...
public class LoadData {
    ...
    public void loadSomeData() {
        ...
        modelArrayAddingList = new ArrayList<Model>();
        model = new Model("Altima III  (L31)", "Nissan", "");
        modelArrayAddingList.add(model);
        model = new Model("Altima IV  (L32/D32)", "Nissan", "");
        modelArrayAddingList.add(model);
        model = new Model("Altima V  (L33)", "Nissan", "");
        modelArrayAddingList.add(model);
        model = new Model("Maxima VIII  (A36)", "Nissan", "");
        modelArrayAddingList.add(model);
        model = new Model("Murano I  (Z50)", "Nissan", "");
        modelArrayAddingList.add(model);
        model = new Model("Murano II  (Z51)", "Nissan", "");
        modelArrayAddingList.add(model);
        model = new Model("Murano III  (Z52)", "Nissan", "");
        modelArrayAddingList.add(model);
        model = new Model("GT-R  (R35)", "Nissan", "");
        modelArrayAddingList.add(model);
        model = new Model("Tiida  (C11)", "Nissan", "");
        modelArrayAddingList.add(model);
        model = new Model("Tiida  (C13)", "Nissan", "");
        modelArrayAddingList.add(model);
        model = new Model("Note  (E11)", "Nissan", "");
        modelArrayAddingList.add(model);
        model = new Model("Sentra  (B17)", "Nissan", "");
        modelArrayAddingList.add(model);
        model = new Model("Primera  (P12)", "Nissan", "");
        modelArrayAddingList.add(model);
        model = new Model("Pathfinder (R51)", "Nissan", "");
        modelArrayAddingList.add(model);
        model = new Model("Pathfinder  (R52)", "Nissan", "");
        modelArrayAddingList.add(model);
        model = new Model("Juke  (F15)", "Nissan", "");
        modelArrayAddingList.add(model);
        model = new Model("X-Trail  (T31)", "Nissan", "");
        modelArrayAddingList.add(model);
        model = new Model("X-Trail  (T32)", "Nissan", "");
        modelArrayAddingList.add(model);
        model = new Model("Teana  (J31)", "Nissan", "");
        modelArrayAddingList.add(model);
        model = new Model("Teana  (J32)", "Nissan", "");
        modelArrayAddingList.add(model);
        model = new Model("Teana  (L33)", "Nissan", "");
        modelArrayAddingList.add(model);
        model = new Model("Qashqai  (J10)", "Nissan", "");
        modelArrayAddingList.add(model);
        model = new Model("Qashqai  (J11)", "Nissan", "");
        modelArrayAddingList.add(model);
        model = new Model("Almera  (N16)", "Nissan", "");
        modelArrayAddingList.add(model);
        model = new Model("Almera Classic  (B10)", "Nissan", "");
        modelArrayAddingList.add(model);
        model = new Model("Almera  (G15)", "Nissan", "");
        modelArrayAddingList.add(model);
        model = new Model("Terrano  (D10)", "Nissan", "");
        modelArrayAddingList.add(model);
        model = new Model("Micra  (K12)", "Nissan", "");
        modelArrayAddingList.add(model);
        model = new Model("Micra  (K13)", "Nissan", "");
        modelArrayAddingList.add(model);
        model = new Model("Patrol  (Y62)", "Nissan", "");
        modelArrayAddingList.add(model);
        model = new Model("Navara  (D40)", "Nissan", "");
        modelArrayAddingList.add(model);
        model = new Model("Cube III  (Z12)", "Nissan", "");
        modelArrayAddingList.add(model);
        model = new Model("Leaf", "Nissan", "");
        modelArrayAddingList.add(model);
